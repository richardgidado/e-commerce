...
export default function Dashboard() {
   return (
    ...
    //         </div>
    //       </div>
    //       <div className="flex items-center space-x-3 bg-gray-900 rounded-lg p-4 animate-pulse delay-150">
    ...
    //             <div className="bg-indigo-500 h-2.5 rounded-full animate-progress" style={{ width: '75%' }}></div>
    //           </div>
    //         </div>
    //         <div>
